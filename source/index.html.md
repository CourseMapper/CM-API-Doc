...
To create an application, please sign up and login. Once you are logged in, please go to your profile page. On your top right menu, you can see menu "app settings" and click it. Here you can create and manage your application. Start by clicking "Create External App". Fill in the necessary input box, and there you go, your application is created.

# Authentication
 
CourseMapper uses standard OAuth2 to allow access to the API. Once you have created a new application, you will obtain the clientId and clientSecret [here](http://coursemapper/settings/apps). Please make notes these two strings to be used in your application.
